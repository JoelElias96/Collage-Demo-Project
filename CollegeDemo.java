...
public class CollegeDemo {
	...
	public static void main(String []args) {
		...
		System.out.println(c.coursesList());    // Prints the courses

		System.out.println(c.studentsList());    // Prints the students

		c.removeStudent(0);  // Removes the first student in the list
		c.removeCourse(4);  // Removes a student somewhere inside the list
